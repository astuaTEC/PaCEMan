...
public class PacMan implements EntityA {
     ...
     * @return Point with row and column where it is
     */
    public Point getPos(){
    ...
    /**
     * update Pacman's position on Controller
     */
    ...
    /**
     * Verify that pacman is in a specific position
    ...
    /**
     * Update in the controller class where pacman is moving
     */
    void updateMovement(){
        c.left = left;
        c.right = right;
    ...
    /**
     * Check if there is a collision between pacman and a wall
     */
    ...
    /**
     * check if it collides with a ghost
     */
    private void ghostCollision(){
        ...
        for(int i = 0; i < game.eb.size(); i++){
            ...
            if(Physics.Collision(this, tempEnt)){
                // If the ghosts aren't blinking
                if(!tempEnt.isFlash()) {
                    //game.death.play();
                    game.client.enviar("n6");
                    isDeath = true;
    ...
    /**
     * Check for collision with an EntityC (Fruit, Pill, pacDots)
     */
    ...
    /**
     * check if pacman died or not
     * to use the corresponding animations
     */
     ...
     * @param entityB to classify it according to its class
     */
